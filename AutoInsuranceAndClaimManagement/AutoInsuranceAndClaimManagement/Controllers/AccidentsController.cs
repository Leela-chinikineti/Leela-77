...
namespace AutoInsuranceAndClaimManagement.Controllers
{
    ...
    public class AccidentsController : ControllerBase
    {
        ...
        public AccidentsController(AutoInsuranceAndClaimManagementDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PostAccident([FromBody] Accident accident)
        {
            ...
            return CreatedAtAction("GetAccident", new { id = accident.Accident_Id }, accident);
        }
        ...
        {
            return _context.Accident.Any(e => e.Accident_Id == id);
        }
    }
}